...
- `DATA_DIR` 目录可写
- 防火墙已放行后端端口
- 如果需要局域网外访问，建议使用 ZeroTier、Tailscale 这类虚拟局域网工具
...
**它不适合直接暴露到公网，也不建议只靠反向代理把服务开放到公网。**

如果确实需要外网访问，建议使用虚拟局域网或内网穿透方案，例如：

- [ZeroTier](https://www.zerotier.com/)
- [Tailscale](https://tailscale.com/)

这类工具会把你的设备加入同一个私有网络，再通过内网地址访问 codex-web，风险比直接把服务端口暴露到公网低得多。
